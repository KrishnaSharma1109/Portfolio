...
const Contact = () => {
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center  ' style={{ backgroundSize: '90% auto' }}>
       <motion.h4
    ...
    transition={{duration:0.5,delay:0.7}}
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Have a question or just want to say hi?
I’d love to hear from you — drop a message below!</motion.p>
    <motion.form
    initial={{opacity:0}}
    whileInView={{opacity:1}}
    transition={{delay:0.9,duration:0.5}}
    className='max-w-2xl mx-auto' onSubmit={onSubmit} >
        <div className='grid grid-cols-[repeat(auto-fit,minmax(100px,1fr))] gap-6 mt-10 mb-8'>
